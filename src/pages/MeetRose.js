    ...
    <div className="meetBG">
      <Container>
        ...
        <Row>
          ...
          services to individuals, couples, families and adolescents in the
          Calgary area. Congratulations on being brave and taking the first step
          to bettering your mental health. In a world that is often too loud and
          busy, it is easy to fall into thought patterns that you are lacking;
          as a therapist, it is my role to help you shift that narrative from
          deficit to plenty. I believe mental health operates on a continuum and
          that is reasonable and expected that all of us will struggle with our
          emotions from time to time. In the current climate we are facing,
          people are experiencing unprecedented amounts of stress, isolation and
          relationship breakdown. As a therapist my role is to create a safe and
          empathetic space for you to be vulnerable and show up as your
          authentic self. No matter what the issue is you are facing, you can
          trust that together we will come to understand the problem, learn
          skills to help you manage distress, quiet troubling thoughts and adapt
          your reactions to the problem. My formal education and training has
